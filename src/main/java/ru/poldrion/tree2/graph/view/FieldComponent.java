package ru.poldrion.tree2.graph.view;

import ru.poldrion.stack.SimpleQueue;
import ru.poldrion.stack.SimpleStack;
import ru.poldrion.tree2.graph.model.GraphModel;
import ru.poldrion.tree2.graph.model.GraphNode;
...
public class FieldComponent extends JComponent {
    ...
    public void startDeep() {
        ...
        //TODO проверить что будет если убить строчку ниже
//        SimpleStack<GraphNode> stack = new SimpleStack<>();
    ...
    public void startWide() {
        ...
        while (!currentNode.hasObject() && !queue.isEmpty()) {
